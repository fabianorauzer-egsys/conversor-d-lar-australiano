import { getDolarAustraliano } from './api.js';
...
function adicionarLinha(reais, dolares, descricao, temAcomodacao) {
  ...
  colunaReais.textContent = isNaN(reais) ? '3.51' : reais.toFixed(2);
...
async function onSubmitDolar(event) {
